...
c2 = gmsh.model.occ.addCylinder(0, 0, -0.5, 0, 0, 1, r=1.4)
ring = gmsh.model.occ.cut([(3, c1)], [(3, c2)], removeTool=False)[0]
gmsh.model.occ.synchronize()

c3 = gmsh.model.occ.addCylinder(0, 0, -0.2, 0, 0, 0.4, r=1.6, angle=0.1)
hole = gmsh.model.occ.fuse([(3, c3)], [(3, c2)])[0]
gmsh.model.occ.fragment([(3, b1)], [ring[0], hole[0]])
#w = gmsh.model.occ.fragment([ring], [(3, c3)])[0]
#total = gmsh.model.occ.fragment([(3, b1)], w)
gmsh.model.occ.synchronize()
