...
Durch Weglassen der Oberflächenterme in der schwachen Formulierung
werden effektiv adiabatische Randbedingungen festgelegt, da der
Randterm $\overline{D} \nabla c = 0$ auch auf $\partial_t q = 0$
schließen lässt.
