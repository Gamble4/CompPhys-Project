...
er gibt den ''Temperaturfluss'' durch den Rand des Gebietes. Dies führt uns zu der Definition.


\begin{definition}[Temperaturfluss]
    \[
        \overline{D} (\nabla c \cdot n)
    \]
    Wobei $n$ der Flächennormalvektor der Oberfläche ist, die durchströmt
    wird.
\end{definition}


Der Ausdruck hängt mit der Wärmestromdichte am Rand zusammen.


\[
    \partial_t q|_{\partial \Omega} = - \lambda \nabla c = - \rho c_\rho \overline{D} (\nabla c \cdot n)
\]  
